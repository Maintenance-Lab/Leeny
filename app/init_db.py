...
def insert_dummy_data():
    ...
    with app.app_context():
        ...
        products = [    
            ...
            Product(id=9, title='Lenovo ThinkPad X1 Carbon', barcode='7854123698574123', quantity=10, price_when_bought=1700.0, description='The Lenovo ThinkPad X1 Carbon is a premium ultrabook with a durable carbon fiber chassis and long battery life. With a vibrant display and powerful performance, this laptop is perfect for business users.', url='https://lenovo.com/thinkpad-x1-carbon', documentation='https://example.com/products/A009', notes='This is a note about the product.', quantity_unavailable=0, manufacturer_id=8, category_id=2, vendor_id=10),
