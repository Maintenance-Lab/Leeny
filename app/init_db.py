...
def insert_dummy_data():
    ...
    with app.app_context():
        ...
        products = [
            ...
            Product(id=8, title='Google Pixel 7', barcode='9876543214567890', quantity=25, price_when_bought=900.0, description='The Google Pixel 7 is a flagship smartphone with a stunning display and advanced camera system. With Googles latest AI features and Android 13, this phone offers a seamless user experience.', url='https://google.com/pixel-7', documentation='https://example.com/products/A008', notes='This is a note about the product.', quantity_unavailable=0, manufacturer_id=7, category_id=1, vendor_id=9),
            Product(id=9, title='Lenovo ThinkPad X1 Carbon', barcode='7854123698574123', quantity=0, price_when_bought=1700.0, description='The Lenovo ThinkPad X1 Carbon is a premium ultrabook with a durable carbon fiber chassis and long battery life. With a vibrant display and powerful performance, this laptop is perfect for business users.', url='https://lenovo.com/thinkpad-x1-carbon', documentation='https://example.com/products/A009', notes='This is a note about the product.', quantity_unavailable=0, manufacturer_id=8, category_id=2, vendor_id=10),
            Product(id=10, title='Canon EOS R5', barcode='1236547893214568', quantity=7, price_when_bought=3500.0, description='The Canon EOS R5 is a professional full-frame mirrorless camera with 45MP resolution and 8K video recording. With advanced autofocus and image stabilization, this camera delivers exceptional results for photographers and videographers alike.', url='https://canon.com/eos-r5', documentation='https://example.com/products/A010', notes='This is a note about the product.', quantity_unavailable=0, manufacturer_id=9, category_id=4, vendor_id=11),
                    ]
