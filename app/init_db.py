...
def insert_dummy_data():
    ...
    with app.app_context():
        ...
        products = [
            Product(id=1, title='V2 UNIT AI.CAMERA', barcode='8720354014806', quantity_total=3, price_when_bought=75.0, description='The LG OLED C1 65" 4K TV offers stunning picture quality with OLED technology and 4K resolution. With support for Dolby Vision and Dolby Atmos, this TV delivers an immersive viewing experience.', url='https://lg.com/oled-c1-65', documentation='https://example.com/products/A007', notes='',   manufacturer_id=1, category_id=5, vendor_id=8),
            Product(id=2, title='BG-4 Tripod power bank grip', barcode='9780099271451', quantity_total=1, price_when_bought=30.0, description='The Google Pixel 7 is a flagship smartphone with a stunning display and advanced camera system. With Googles latest AI features and Android 13, this phone offers a seamless user experience.', url='https://google.com/pixel-7', documentation='https://example.com/products/A008', notes='',   manufacturer_id=7, category_id=1, vendor_id=9),
            Product(id=3, title='M5-WATCH Stickc plus', barcode='9780340654286 ', quantity_total=1, price_when_bought=25.0, description='M5StickC PLUS is powered by ESP32-PICO-D4 with Wi-Fi and is an upgrade of the original M5StickC with a bigger screen .It is a portable, easy-to-use, open source, IoT development board. This tiny device will enable you to realize your ideas, enrich your creativity, and speed up your IoT prototyping. Developing with M5StickC PLUS takes away a lot of the pains from the development process. M5StickC Plus is one of the core devices in M5Stacks product series. The compact body is integrated with rich hardware resources, such as infrared, RTC, Microphone, LED, IMU, Buttons, PMU,etc. Improvements from the regular StickC are a buzzer, bigger screen (1.14-inch, 135 * 240 resolution LCD Screen) and more stable hardware design. This revision increases the display area by 18.7%, and the battery capacity from 95mAh to 120mAh. It also supports the HAT and Unit family of products. Power switch operation: Power on :Press power button for 2 seconds Power off :Press power button for 6 seconds',   manufacturer_id=1, category_id=2, vendor_id=10),
        ...
        borrowed = [
            ...
            Borrowed(product_id=16, user_id=1, quantity=2, returned=0, estimated_return_date=int((datetime.now() + timedelta(days=-1)).timestamp()), project="Test"),
        ]
