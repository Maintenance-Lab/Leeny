...
app.config['MAIL_USERNAME'] = 'leeny.maintenance@gmail.com'  # Use your actual Gmail address
app.config['MAIL_PASSWORD'] = 'xzou bejm kwlg bsgy'     # Use your generated App Password
