...
def insert_dummy_data():
    ...
    with app.app_context():
        ...
        users = [
            Users(id='1', fullname='AmberAdmin', email='amber@a.nl', uid_1='44032007048a3e12796a80', study='Data Science', faculty='GSI UvA', role='admin'),
            Users(id='2', fullname='StudentAmber', email='amber@hva.nl', uid_1='02001804d7919327', study='Data Science', faculty='GSI UvA', role='student'),
            Users(id='3', fullname='Donna', email='donna@donna.nl', uid_1='440008070499d1aa3e3e80', study='Maintenance Lab', faculty='HvA', role='admin', password='1'),
            Users(id='4', fullname='Tom Goemans', email='tom@goemans.nl', uid_1='440008070499d1aa3e3e80', study='Data Science', faculty='GSI UvA', role='admin', password='1')
        ]
