...
def insert_dummy_data():
    ...
    with app.app_context():
        ...
        vendors = [
            Vendor(vendor_name='KIWI Electronics', website='https://www.kiwi-electronics.com'),
            Vendor(vendor_name='Distrelec', website='https://www.distrelec.nl'),
            Vendor(vendor_name='Conrad', website='https://www.conrad.nl'),
            Vendor(vendor_name='SOS solutions', website='https://www.sossolutions.nl'),
            Vendor(vendor_name='Toolstation', website='https://www.toolstation.nl'),
            Vendor(vendor_name='HBM', website='https://www.hbm-machines.com'),
            Vendor(vendor_name='Digikey Electronics', website='https://www.digikey.nl'),
            Vendor(vendor_name='Vanallesenmeer.nl', website='https://www.vanallesenmeer.nl'),
            Vendor(vendor_name='Bol.com', website='https://www.bol.com'),
            Vendor(vendor_name='Amazon', website='https://www.amazon.com'),
            Vendor(vendor_name='AliExpress', website='https://www.aliexpress.com'),
            Vendor(vendor_name='eBay', website='https://www.ebay.com'),
            Vendor(vendor_name='Newegg', website='https://www.newegg.com'),
            Vendor(vendor_name='Mouser', website='https://www.mouser.com'),
            Vendor(vendor_name='RS Components', website='https://www.rs-online.com'),
            Vendor(vendor_name='Farnell', website='https://www.farnell.com'),
            Vendor(vendor_name='TME', website='https://www.tme.eu'),
            Vendor(vendor_name='Digi-Key', website='https://www.digikey.com'),
            Vendor(vendor_name='Element14', website='https://www.element14.com'),
            Vendor(vendor_name='Mouser Electronics', website='https://www.mouser.com'),
        ]
